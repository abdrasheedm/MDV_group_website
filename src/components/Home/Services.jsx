      ...
      <div className="container mx-auto text-white py-20 ">
        <div className="bg-gray-400 bg-opacity-30 px-10 py-20">
          ...
          <div className="grid grid-cols-3 ">
            <div className="col-span-3 lg:col-span-1 bg-white bg-opacity-95 text-gray-900 border-2 mx-10 p-10 mb-10">
              <img src={AccountingService} alt="" className="h-16" />
              <h2>Accounting Services</h2>
              <p className="font-medium">
                Expert accounting services for accurate bookkeeping, financial
                reporting, and regulatory compliance. Make informed decisions
                with ease... <span className="font-bold hover:cursor-pointer" onClick={() => navigate('service/accounting-service-bookkeeping-firm/')}>Read More</span>{" "}
              </p>
            </div>
            <div className="col-span-3 lg:col-span-1 bg-white bg-opacity-95 text-gray-900 border-2 mx-10 p-10 mb-10">
              ...
              <p className="font-medium">
                Comprehensive tax consultancy for VAT, corporate tax, and excise
                tax compliance. Navigate complex regulations with expert
                guidance... <span className="font-bold hover:cursor-pointer">Read More</span>{" "}
              </p>
            </div>
            <div className="col-span-3 lg:col-span-1 bg-white bg-opacity-95 text-gray-900 border-2 mx-10 p-10 mb-10">
              ...
              <p className="font-medium">
                Professional auditing services to assess financial statements,
                internal controls, and risk management. Ensure regulatory
            ...
            <div className="col-span-3 lg:col-span-1 bg-white bg-opacity-95 text-gray-900 border-2 mx-10 p-10 mb-10">
              ...
              <p className="font-medium">
                Company formation in UAE/UAE. Expert assistance for company
            ...
            <div className="col-span-3 lg:col-span-1 bg-white bg-opacity-95 text-gray-900 border-2 mx-10 p-10 mb-10">
              ...
              <p className="font-medium">
                Zoho Authorized Partner offering tailored software
                implementation, customization, and support. Empower your
                business with cutting-edge technol..{" "}
                <span className="font-bold hover:cursor-pointer">Read More</span>{" "}
              </p>
            </div>
            <div className="col-span-3 lg:col-span-1 bg-white bg-opacity-95 text-gray-900 border-2 mx-10 p-10 mb-10">
              ...
              <p className="font-medium">
                Specialized compliance services for AML, UBO, and ESR
                regulations. Ensure adherence and minimize risk with expert
                support... <span className="font-bold hover:cursor-pointer">Read More</span>{" "}
              </p>
            </div>
          </div>
        </div>
